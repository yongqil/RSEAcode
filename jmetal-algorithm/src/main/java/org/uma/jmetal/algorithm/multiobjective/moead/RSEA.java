 ...
 * @author yongqiliu @qq 510596430 @tel 136168681951
 * @Email yongqil@hust.edu.cn
...
public class RSEA<S extends Solution<?>>  extends AbstractMOEAD<DoubleSolution>{
	...
	public RSEA(Problem<DoubleSolution> problem,
			int populationSize,
	...
	@Override public void run() {
		...
		do {
			...
			for (int i = 0; i < populationSize; i++) {
				...
				updateNeighborhoodNew(child, subProblemId, neighborType, childReg, 2);
			}
...
//		randomGenerator.setSeed(1527150823434l);//
	...
	@Override public String getDescription() {
		return "A Region Search Evolutionary Algorithm for Many-Objective Optimization" ;
	}
