 ...
 */
public class MOEAD_RSRunner extends AbstractAlgorithmRunner {
	/**
  ...
  java org.uma.jmetal.runner.multiobjective.MOEADRunner problemName [referenceFront]
	...
	public static void main(String[] args) throws FileNotFoundException, MWException {
		...
		//      referenceParetoFront = "/pareto_fronts/ZDT2.pf";
		//      referenceParetoFront = "/pareto_fronts/WFG5.2D.pf";
...
//		    problem = new  C3_DTLZ4(nfun+4,nfun,nfun);
		...
		algorithm =new MOEADBuilder(problem, MOEADBuilder.Variant.MOEAD_RS)
				.setCrossover(crossover)
				.setMutation(mutation)
				.setPopulationSize(91)
				.setMaxEvaluations(91*3000)
				//                .setMaxEvaluations(210*350)
				//                .setMaxEvaluations(156*750)
				//                .setMaxEvaluations(275*4000)
				//                .setMaxEvaluations(135*4500)
