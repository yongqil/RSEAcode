...
/**
 * Class representing problem SDTLZ2
 */
@SuppressWarnings("serial")
public class SDTLZ2 extends AbstractDoubleProblem {
  /**
   * Creates a SDTLZ2 problem (12 variables and 3 objectives)
   */
  public SDTLZ2() {
    this(12, 3);
  }
  ...
  public void evaluate(DoubleSolution solution) {
    ...
    double factor = getFactor(numberOfObjectives);
  ...
  private double getFactor(int obj) {
  	if (obj == 3)
  		return 10;
  	else if (obj == 5)
  		return 10;
